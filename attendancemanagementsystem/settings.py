"""
Django settings for attendancemanagementsystem project.
...
SECRET_KEY = "django-insecure-trb(w6b+cbgcoytpd$laugn10gla6(%nqo*kzk7!mf5wuayjf2"
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        # 'rest_framework.permissions.IsAuthenticated',  # Example: Only authenticated users are allowed
